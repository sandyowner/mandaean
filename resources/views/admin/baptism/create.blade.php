        ...
        <div class="card">
            <div class="card-body">
                <form class="forms-sample" method="POST" action="{{route('size.store')}}" enctype='multipart/form-data'>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="exampleInputEmail3">Code</label>
                        <input type="text" class="form-control" id="ar_code" name="ar_code" placeholder="Code" value="{{old('ar_code')}}">
                        @error('ar_code')
                            <p style="color: red">{{$message}}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="exampleInputName1">Name</label>
                        <input type="text" class="form-control" id="pe_name" name="pr_name" placeholder="Name" value="{{old('pe_name')}}">
                        @error('pe_name')
                            <p style="color: red">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="form-group col-sm-12">
                        <label for="exampleInputEmail3">Code</label>
                        <input type="text" class="form-control" id="pe_code" name="pe_code" placeholder="Code" value="{{old('pe_code')}}">
                        @error('pe_code')
                            <p style="color: red">{{$message}}</p>
                        @enderror
                    </div>
